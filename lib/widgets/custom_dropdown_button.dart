...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  _MenuLimits getMenuLimits(
    ...
    // fix: set [selectedItemOffset] to -55 to display the menu
    // below the CustomDropdownButtonFormField
    // final double selectedItemOffset = getItemOffset(index);
    const double selectedItemOffset = -55;
...
class _DropdownButtonState<T> extends State<DropdownButton<T>>
  ...
  void _handleTap() {
    ...
    // fix: removed unnecessary _kUnalignedMenuMargin
  ...
  Widget build(BuildContext context) {
    ...
    // fix: removed unnecessary _kAlignedButtonPadding
    const EdgeInsetsGeometry padding = _kUnalignedButtonPadding;
